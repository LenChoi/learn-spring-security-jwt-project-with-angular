...
import com.supportpotal.supportpotal.exception.domain.*;
...
public class UserResource extends ExceptionHandling {
    ...
    @PreAuthorize("hasAnyAuthority('user:delete')") //delete 권한 있는 유저만 삭제 가능
    ...
    public byte[] getTempProfileImage(@PathVariable("username") String username) throws IOException {
        ...
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(); //url로 나온 데이터를 저장한다.
